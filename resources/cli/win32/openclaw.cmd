...
if /i "%1"=="update" (
    echo openclaw is managed by canvasland ^(bundled version^).
    echo.
    echo To update openclaw, update canvasland:
    echo   Open canvasland ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=canvasland
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\canvasland.exe" "%OPENCLAW_ENTRY%" %*
)
