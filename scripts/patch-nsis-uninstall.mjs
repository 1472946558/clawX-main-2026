 ...
 * shows a misleading "app cannot be closed" dialog even when canvasland is not running.
 */
...
const PATCH_MARKER = 'canvasland-patched: skip legacy uninstaller';

const SKIP_LEGACY_UNINSTALLER = [
  '  ; canvasland-patched: skip legacy uninstaller on upgrades.',
