...
describe('installer.nsh running-app guard', () => {
  it('fails closed when canvasland.exe remains alive during overwrite install', () => {
    ...
    expect(guard).toContain('canvasland is still running and cannot be replaced safely');
