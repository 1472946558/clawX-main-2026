 ...
 * "openrouter.ai" carries the canvasland app-attribution headers.
 *
...
(function () {
  ...
  globalThis.fetch = function clawxFetch(input, init) {
    ...
    if (url.indexOf('openrouter.ai') !== -1) {
      ...
      delete flat['X-OpenRouter-Title'];
      flat['HTTP-Referer'] = 'https://github.com/andy777chen/CanvaslandAI';
      flat['X-OpenRouter-Title'] = 'canvasland';
      init.headers = flat;
    }
