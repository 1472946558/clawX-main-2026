...
// 4b. Collect extra packages required by canvasland's Electron main process that are
          ...
          try {
            ...
            if (!original.includes('exports.LRUCache')) {
              const patched = [
                original,
                '',
                '// canvasland patch: add LRUCache named export for Node.js 22+ ESM interop',
