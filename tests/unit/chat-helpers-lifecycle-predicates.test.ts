 ...
 * canvasland's UI keeps the Thinking… indicator / Execution Graph "active" or
 * tears them down.
 *
 * In production, canvasland consumes already-normalized messages from the OpenClaw
 ...
 * provider protocols canvasland may encounter.
 */
