...
test('skill marketplace renders commercial-use source cards with search', async ({ page }) => {
  ...
  await expect(page.getByTestId('skill-marketplace-status-spec-driven-development')).toHaveText('Installed');
  ...
  await expect(page.getByTestId('skill-marketplace-action-spec-driven-development')).toHaveText('Use');
  ...
  await expect(page.getByTestId('skill-marketplace-card-spec-driven-development')).toBeVisible();
  await expect(page.getByTestId('skill-marketplace-action-spec-driven-development')).toBeEnabled();
